...
<br><br>
- Numpad1 = f15 (for custom button) <br>
- Numpad2 = Volume_Down<br>
- Numpad3 = f16 (for custom button) <br><br>
- Numpad4 = Media_Prev<br>
- Numpad5 = Media_Play_Pause<br>
- Numpad6 = Media_Next<br><br>
- Numpad7 = f17 (for custom button) <br>
- Numpad8 = Volume_Up<br>
- Numpad9 = f18 (for custom button) <br>
